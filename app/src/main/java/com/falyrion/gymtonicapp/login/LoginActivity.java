package com.falyrion.gymtonicapp.login;
...
import com.falyrion.gymtonicapp.BMI.BMIActivity;
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(userName)) {
                    Toast.makeText(LoginActivity.this, "I haven't registered an account yet!", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (TextUtils.equals(account, userName)) {
                    if (TextUtils.equals(password, pass)) {
                        ...
                        Toast.makeText(LoginActivity.this, "Congratulations, you have successfully logged in!", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(LoginActivity.this, "User name error!", Toast.LENGTH_LONG).show();
                }
